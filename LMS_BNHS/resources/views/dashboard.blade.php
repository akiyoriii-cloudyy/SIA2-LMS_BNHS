                ...
                <div class="admin-qgroups" style="grid-template-columns: repeat(auto-fill, minmax(220px, 1fr));">
                    <div class="admin-qgroup" style="margin:0;">
                        ...
                        <div class="admin-qgroup-cards">
                            ...
                            <a class="admin-qcard" href="{{ route('admin.security-audit.index') }}">
                                <span class="admin-qcard-icon">&#128269;</span>
                                <span class="admin-qcard-body">
                                    <span class="admin-qcard-label">Security Audit</span>
                                    <span class="admin-qcard-desc">Security monitoring and alerts</span>
                                </span>
                            </a>
                            <a class="admin-qcard" href="{{ route('admin.transactions.index') }}">
                                <span class="admin-qcard-icon">&#128202;</span>
                                <span class="admin-qcard-body">
                                    <span class="admin-qcard-label">Transactions</span>
                                    <span class="admin-qcard-desc">Business transactions and logs</span>
                                </span>
                            </a>
                        </div>
                    </div>
