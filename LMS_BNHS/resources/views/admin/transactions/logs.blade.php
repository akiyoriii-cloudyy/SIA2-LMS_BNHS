...
/* Tailwind CSS Pagination Styling - Override Laravel's default pagination */
...
nav[aria-label="Pagination"] a.inline-flex,
nav[aria-label="Pagination"] span.inline-flex {
...
/* Hover effects */
nav[aria-label="Pagination"] a.inline-flex:hover {
...
/* Previous/Next buttons - TEXT ONLY */
nav[aria-label="Pagination"] a[rel="prev"],
...
nav[aria-label="Pagination"] a[rel="prev"]:hover,
nav[aria-label="Pagination"] a[rel="next"]:hover {
    background: #545b62 !important;
    border-color: #545b62 !important;
}

/* HIDE SVG ICONS - SHOW TEXT ONLY */
nav[aria-label="Pagination"] a[rel="prev"] svg,
nav[aria-label="Pagination"] a[rel="next"] svg {
    display: none !important;
}

/* Add text content to prev/next buttons using CSS */
nav[aria-label="Pagination"] a[rel="prev"]::before {
    content: "Previous" !important;
    color: white !important;
    font-weight: 500 !important;
}

nav[aria-label="Pagination"] a[rel="next"]::after {
