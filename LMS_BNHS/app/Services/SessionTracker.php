...
class SessionTracker
{
    ...
    private function getBrowser(string $userAgent): string
    {
        ...
        // Check for Mozilla Firefox specifically
        if (str_contains($ua, 'firefox') && str_contains($ua, 'mozilla')) return 'Mozilla Firefox';
        ...
        if (str_contains($ua, 'mozilla')) return 'Mozilla';
